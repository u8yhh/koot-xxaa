...
if [[ -z "${Vless_Path}" ]]; then
  Vless_Path="/9f0cfd2f-f755-4a0c-a14d-146c5a74be43-vless"
fi
echo ${Vless_Path}

if [[ -z "${Vless_UUID}" ]]; then
  Vless_UUID="9f0cfd2f-f755-4a0c-a14d-146c5a74be43"
fi
echo ${Vless_UUID}

if [[ -z "${Vmess_Path}" ]]; then
  Vmess_Path="/9f0cfd2f-f755-4a0c-a14d-146c5a74be43-vmess"
fi
echo ${Vmess_Path}

if [[ -z "${Vmess_UUID}" ]]; then
  Vmess_UUID="9f0cfd2f-f755-4a0c-a14d-146c5a74be43"
fi
echo ${Vmess_UUID}
